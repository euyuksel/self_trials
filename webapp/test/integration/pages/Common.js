sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/euy/test/List01/app", ".html");
		...
		return Opa5.extend("com.euy.test.List01.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/euy/test/List01/localService/mockserver"], function (mockserver) {
